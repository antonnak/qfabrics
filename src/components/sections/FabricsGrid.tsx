        ...
        <div className="grid md:grid-cols-2 gap-5">
          {fabrics.map((fabric) => (
            <Link
              ...
              className="group relative bg-background border border-border rounded-lg p-6 transition-all duration-200 hover:border-border-hover hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
